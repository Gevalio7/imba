...
async function addTicketsTestData() {
  try {
    ...
    if (types.length === 0)
      console.log('Warning: No types found')
    if (priorities.length === 0)
      console.log('Warning: No priorities found')
    if (queues.length === 0)
      console.log('Warning: No queues found')
    if (states.length === 0)
      console.log('Warning: No states found')
    if (agents.length === 0)
      console.log('Warning: No agents found')
    if (customers.length === 0)
      console.log('Warning: No customers found')
    if (slas.length === 0)
      console.log('Warning: No SLAs found')
