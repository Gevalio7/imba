...
async function initializeDatabase() {
  try {
    ...
    const prioritiesCount = Number.parseInt(prioritiesCountResult.rows[0].count)
    ...
    const entities = [
      ...
      'calendars',
      'communication_log',
      'communication_notifications_settings',
      'customers',
      'customers_groups',
      'customer_users',
      ...
      'pgp_keys',
      'post_master_filters',
      'post_master_mail_accounts',
      'processes_automation_settings',
      'process_management',
      'queue_auto_response',
      'queues',
      'roles',
