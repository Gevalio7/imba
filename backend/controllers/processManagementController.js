...
const createProcessManagement = async (req, res) => {
  try {
    ...
    const newProcessManagement = await ProcessManagement.create({ name, description, status, isActive });
...
const updateProcessManagement = async (req, res) => {
  try {
    ...
    const updatedProcessManagement = await ProcessManagement.update(processmanagementId, { name, description, status, isActive });
