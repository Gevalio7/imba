...
const createCommunicationNotificationsSettings = async (req, res) => {
  try {
    ...
    const newCommunicationNotificationsSetting = await CommunicationNotificationsSettings.create({ name, description, status, isActive });
...
const updateCommunicationNotificationsSettings = async (req, res) => {
  try {
    ...
    const updatedCommunicationNotificationsSetting = await CommunicationNotificationsSettings.update(communicationnotificationssettingId, { name, description, status, isActive });
