...
const createPostMasterFilters = async (req, res) => {
  try {
    ...
    const newPostMasterFilter = await PostMasterFilters.create({ name, description, status, isActive });
...
const updatePostMasterFilters = async (req, res) => {
  try {
    ...
    const updatedPostMasterFilter = await PostMasterFilters.update(postmasterfilterId, { name, description, status, isActive });
