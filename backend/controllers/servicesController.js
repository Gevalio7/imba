...
const addServiceCustomer = asyncHandler(async (req, res) => {
  ...
  const serviceId = Number.parseInt(id, 10)
  const customerIdInt = Number.parseInt(customerId, 10)
...
const removeServiceAttachment = asyncHandler(async (req, res) => {
  ...
  const serviceId = Number.parseInt(id, 10)
  const attachmentIdInt = Number.parseInt(attachmentId, 10)
...
const setServiceSLA = asyncHandler(async (req, res) => {
  ...
  const slaIdInt = req.body.slaId !== undefined
    ? (req.body.slaId ? Number.parseInt(req.body.slaId, 10) : null)
    : null
