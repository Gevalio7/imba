...
const resetCustomizer = async () => {
  if (isCookieHasAnyValue.value) {
    ...
    cookieRef('lightThemePrimaryColor', staticPrimaryColor).value = staticPrimaryColor
    cookieRef('darkThemePrimaryColor', staticPrimaryColor).value = staticPrimaryColor
    cookieRef('lightThemePrimaryDarkenColor', staticPrimaryDarkenColor).value = staticPrimaryDarkenColor
    cookieRef('darkThemePrimaryDarkenColor', staticPrimaryDarkenColor).value = staticPrimaryDarkenColor
