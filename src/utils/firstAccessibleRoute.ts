...
const ROUTE_NAME_TO_PATH: Record<string, string> = {
  ...
  'apps-post-master-mail-accounts': '/apps/PostMasterMailAccounts',
  'apps-post-master-mail-accounts-add': '/apps/PostMasterMailAccounts/add',
  'apps-post-master-mail-accounts-edit': '/apps/PostMasterMailAccounts/edit',
