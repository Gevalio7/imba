...
// Данные клиентов (демо данные)
const customers = ref<Customer[]>([
  {
    id: 1,
    name: 'company1',
    message: 'Клиент компании для поддержки',
  ...
  },
  {
    id: 2,
    name: 'company2',
    message: 'Клиент для запросов продаж',
  ...
  },
  {
    id: 3,
    name: 'company3',
    message: 'Общий клиент для информационных запросов',
  ...
  },
  {
    id: 4,
    name: 'company4',
    message: 'Клиент для финансовых вопросов',
  ...
  },
  {
    id: 5,
    name: 'company5',
    message: 'Архивный клиент, больше не используется',
  ...
  },
  {
    id: 6,
    name: 'company6',
    message: 'Клиент для сбора отзывов',
...
const confirmBulkDelete = () => {
  ...
  selectedItems.value.forEach(item => {
    const index = customers.value.findIndex(t => t.id === item.id)
    if (index !== -1) {
...
const save = () => {
  ...
  if (editedIndex.value > -1) {
    ...
    // Добавление нового
    const newId = Math.max(...customers.value.map(t => t.id)) + 1
...
const toggleStatus = (item: Customer, newValue: number) => {
  ...
  const index = customers.value.findIndex((t: Customer) => t.id === item.id)
...
<template>
  <div>
    ...
    <VDialog
      ...
      max-width="600px"
    >
      <VCard :title="editedIndex > -1 ? 'Редактировать клиента' : 'Добавить клиента'">
        <VCardText>
          <VRow>
            <!-- Название -->
            <VCol
