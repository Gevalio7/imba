...
// Фильтрация
const filteredWebServices = computed(() => {
...
const toggleStatus = async (item: WebServices, newValue: boolean) => {
...
<template>
  <div>
    <VCard title="Веб-сервисы">
      ...
      >
        <VCard title="Подтверждение удаления">
          <VCardText>
            Вы уверены, что хотите удалить выбранные веб-сервисы? Это действие нельзя отменить.
          </VCardText>
          <VCardText>
            <div class="d-flex justify-end gap-4">
              <VBtn
      ...
      <div class="d-flex justify-center mt-4 pb-4">
        <VPagination
          v-model="currentPage"
          :length="Math.ceil(filteredWebServices.length / itemsPerPage) || 1"
    ...
    <VDialog
      ...
      max-width="500px"
    >
      <VCard title="Вы уверены, что хотите удалить этот веб-сервис?">
        <VCardText>
