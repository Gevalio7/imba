...
const defaultItem = ref<CommunicationLog>({
  id: -1,
  name: '',
  message: '',
  createdAt: '',
...
const editedItem = ref<CommunicationLog>({ ...defaultItem.value })
...
const toggleStatus = async (item: CommunicationLog, newValue: boolean | null) => {
