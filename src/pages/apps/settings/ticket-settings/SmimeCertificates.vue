...
// Фильтрация
const filteredSmimeCertificates = computed(() => {
...
const toggleStatus = async (item: SmimeCertificates, newValue: boolean | null) => {
  ...
  <div>
    <VCard title="S/MIME сертификаты">
      ...
      <VDataTable
        ...
        :headers="headers"
        :items="filteredSmimeCertificates"
        show-select
      ...
      <div class="d-flex justify-center mt-4 pb-4">
        <VPagination
          v-model="currentPage"
          :length="Math.ceil(filteredSmimeCertificates.length / itemsPerPage) || 1"
