...
const toggleStatus = async (item: CustomerUsersServices, newValue: boolean | null) => {
    ...
    <VCard title="Сервисы пользователей клиентов">
      ...
      >
        <VCard title="Подтверждение удаления">
          <VCardText>
            Вы уверены, что хотите удалить выбранные сервисы пользователей клиентов? Это действие нельзя отменить.
          </VCardText>
          <VCardText>
            <div class="d-flex justify-end gap-4">
              <VBtn
