...
<template>
  <div class="organization-structure">
    <VCard title="Организационная структура">
      ...
      <!-- Индикатор загрузки -->
      <div
        v-if="customersLoading || usersLoading"
      ...
      <!-- Сообщение об ошибке -->
      <div
        v-else-if="customersError || usersError"
        class="d-flex justify-center pa-6"
      >
        <VAlert
          type="error"
      ...
      >
        <!-- Компании -->
        <div
          v-if="companiesWithGroups.length > 0"
          ...
          >
            <VCardText>
              ...
              <div class="users-grid">
                ...
                <div
                  v-if="usersWithoutGroup.length === 0"
                  class="text-center py-4 text-medium-emphasis"
                >
      ...
      <VCard title="Подтверждение удаления">
        ...
        <VCardText class="d-flex justify-center gap-4">
          <VBtn
            color="error"
            variant="outlined"
            @click="closeCompanyDeleteDialog"
          >
            Отмена
          </VBtn>
          <VBtn
